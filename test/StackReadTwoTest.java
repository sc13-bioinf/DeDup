...
public class StackReadTwoTest extends AbstractTest {

  public void setUp () throws IOException {
        in = getClass().getResourceAsStream("/test-resources/stack_read_two_test.bam");
  ...
  public void resolveDuplicate_forward () throws IOException {
    ...
    assertEquals(Data.RMDupperTest__stackReadTwo_expectedReadNames, observedReadNames);
  }
}
