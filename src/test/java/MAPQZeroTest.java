...
public class MAPQZeroTest extends AbstractTest {

  public void setUp () throws IOException {
        in = getClass().getResourceAsStream("/mapq_zero_test.bam");
  ...
  public void resolveDuplicate_strand_forward () throws IOException {
    ...
    assertEquals(Data.RMDupperTest__MAPQZero_expectedReadNames, observedReadNames);
  }
}
